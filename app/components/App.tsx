        ...
        <div className="flex justify-center mb-8">
          <motion.button
            className={`mx-2 px-6 py-2 rounded-full text-lg font-semibold transition-colors duration-200 ${
              activeTab === 'prescribe' ? 'bg-indigo-custom text-white' : 'bg-white text-indigo-custom hover:bg-indigo-100'
            }`}
          ...
          <motion.button
            className={`mx-2 px-6 py-2 rounded-full text-lg font-semibold transition-colors duration-200 ${
              activeTab === 'dashboard' ? 'bg-indigo-custom text-white' : 'bg-white text-indigo-custom hover:bg-indigo-100'
            }`}
          ...
          <motion.button
            className={`mx-2 px-6 py-2 rounded-full text-lg font-semibold transition-colors duration-200 ${
              activeTab === 'chat' ? 'bg-indigo-custom text-white' : 'bg-white text-indigo-custom hover:bg-indigo-100'
            }`}
